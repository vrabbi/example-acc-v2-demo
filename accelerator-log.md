...
```json
{
  ...
  "owner" : "cna-team",
  "system" : "demo-apps",
  "bsGitRepository" : "github.com?owner=vrabbi&repo=example-acc-v2-demo"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=vrabbi&repo=example-acc-v2-demo'
